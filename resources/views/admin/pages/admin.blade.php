...
<main>
    <div class="h-full flex justify-end">
        <button type="button" data-modal-target="popup-tambah" data-modal-toggle="popup-tambah" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">tambah</button>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 text-right flex justify-center gap-1">
                    <button onclick="setEdit(this)"  class="font-medium text-blue-600 dark:text-blue-500 hover:underline" data-modal-target="popup-edit" data-modal-toggle="popup-edit" data-id="{{$value->id}}" >edit</button>
                    <p>|</p>
                    <button data-id="{{$value->id}}" onclick="setDelete(this)" class="font-medium text-red-600 dark:text-red-500 hover:underline" data-modal-toggle="popup-delete" data-modal-target="popup-delete">delete</button>
                </td>
            </tr>
            @endforeach
        </tbody>
...
<!-- Main modal -->
<div id="popup-tambah" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{route('admin.admin.post')}}" method="POST">
                    @csrf
                    <div>
                        <label for="username1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">username</label>
                        <input type="text" name="username" id="username1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="username" required>
                    </div>
                    <div>
                        <label for="password1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">password</label>
                        <input type="password" name="password" id="password1" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
...
<!-- Main modal -->
<div id="popup-edit" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" >
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{route('admin.admin.put')}}" method="POST">
                    @csrf
                    @method('put')
                    <input type="text" id="input-edit" name="id" hidden >
                    <div>
...
<script>
    ...
    function setEdit(params) {
        ...
        data = getDatafromTr(params.parentElement.parentElement);
        input.value = id;
        inputUsername.value = data[0];
        inputPassword.value = data[1];
    }
</script>
@endsection
